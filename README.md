...
| ---------------------------------- | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| **Feature**                        | ![](https://github.com/Dlloydev/jtag2updi/wiki/images/NanoHVpcb.jpg) | ![](https://github.com/Dlloydev/jtag2updi/wiki/images/ATmega0_28pinSmall200.gif) | ![](https://github.com/Dlloydev/jtag2updi/wiki/images/ATtiny16x4PinoutSmall200.gif) | ![](https://github.com/Dlloydev/jtag2updi/wiki/images/NanoHVbreadboard.jpg) |
...
| Max Target Current for Power Cycle |                       PORTC (60-80 mA)                       |     PORTD (60-80 mA) or external High Side Power Switch      |             High Side Power Switch, User Defined             |                       PORTC (60-80 mA)                       |
| 5V to 12V Converter                |                 Dickson Charge Pump, (10mA)                  |                         User defined                         |                         User defined                         | [LTC1262CN8](https://www.analog.com/media/en/technical-documentation/data-sheets/1262fa.pdf) (30mA) |
